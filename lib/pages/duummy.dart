...
class DummyApp extends StatefulWidget {
  ...
  @override
  DummyAppState createState() => DummyAppState();
}

class DummyAppState extends State<DummyApp> {
  String pathPDF = "";
  ...
  void initState() {
    super.initState();
    fromAsset('assets/dart_flutter.pdf', 'dart_flutter.pdf').then((f) {
      setState(() {
        corruptedPathPDF = f.path;
      });
    });
    fromAsset('assets/flutter-questions.pdf', 'flutter-questions.pdf')
        .then((f) {
      setState(() {
        pathPDF = f.path;
      });
    });
    fromAsset('assets/web-bev-syllabus.pdf', 'web-bev-syllabus.pdf').then((f) {
      setState(() {
